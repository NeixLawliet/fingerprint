    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h6 class="mb-0"><i class="fas fa-users me-2 text-primary"></i>Data Karyawan</h6>
...
{{-- MODAL STEP 1: Form data karyawan --}}
            ...
            <div class="modal-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control" id="input-employee_code" placeholder="Opsional">
                    </div>
                    <div class="col-6">
                        <label class="form-label">Departemen</label>
                        <input type="text" class="form-control" id="input-department" placeholder="Opsional">
                    </div>
                    <div class="col-12">
                        <label class="form-label">Jabatan</label>
                        <input type="text" class="form-control" id="input-position" placeholder="Opsional">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                <button class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal">Batal</button>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                <div class="mb-3">
                    <span class="badge bg-primary px-3 py-2" style="font-size:13px" id="fp-employee-name">-</span>
                </div>
            ...
            <div class="modal-footer justify-content-center">
                <button class="btn btn-outline-danger btn-sm" id="btn-cancel-finger">
...
<div class="modal fade" id="done-modal" tabindex="-1">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-center">
                <button class="btn btn-outline-danger btn-sm" data-bs-dismiss="modal">Tutup</button>
            </div>
        </div>
    </div>
</div>
            ...
            <form id="edit-form">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <label class="form-label">Kode Karyawan</label>
                            <input type="text" class="form-control" id="edit-employee_code">
                        </div>
                        <div class="col-6">
                            <label class="form-label">Departemen</label>
...
<script>
    ...
    $(document).on('click', '#add-button', function () {
        $('#input-name, #input-employee_code, #input-department, #input-position').val('');
    ...
    function openFingerModal(employeeName) {
        $('#fp-employee-name').text(employeeName);
    ...
    $(document).on('click', '#edit-data', function (e) {
        ...
        $.ajax({
            ...
            success: function (d) {
                ...
                $('#edit-employee_code').val(d.employee_code ?? '');
                $('#edit-department').val(d.department ?? '');
                $('#edit-position').val(d.position ?? '');
    ...
    $('#edit-form').on('submit', function (e) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({
                name:          $('#edit-name').val(),
                employee_code: $('#edit-employee_code').val(),
