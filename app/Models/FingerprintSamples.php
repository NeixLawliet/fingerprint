 ...
 * @property int    sample_index
 * @property int    deleted_at
 * @property int    created_at
 * @property int    updated_at
 * @property string raw_data
 */
class FingerprintSamples extends Model
{
    use SoftDeletes;
     ...
     * @var string
     */
    protected $table = 'fingerprint_samples';
     ...
     */
    protected $casts = [
        'fingerprint_id' => 'int', 'sample_index' => 'int', 'raw_data' => 'string', 'deleted_at' => 'datetime', 'created_at' => 'datetime', 'updated_at' => 'datetime'
    ];
    ...
    public static function mapSchema($params = [], $user = [])
    {
        ...
        return [
            'field' => [
				...
				'fingerprint_id' => ['column' => $model->table.'.fingerprint_id', 'alias' => 'fingerprint_id', 'type' => 'int'],
				'sample_index' => ['column' => $model->table.'.sample_index', 'alias' => 'sample_index', 'type' => 'int'],
				'raw_data' => ['column' => $model->table.'.raw_data', 'alias' => 'raw_data', 'type' => 'string'],
