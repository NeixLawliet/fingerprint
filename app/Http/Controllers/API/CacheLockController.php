...
class CacheLockController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = CacheLocks::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = CacheLocks::getAllResult($params, $request);
        } else {
            $res = CacheLocks::getPaginatedResult($params, $request);
        }
    ...
    {
        $params = $request->all();
        return CacheLocks::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return CacheLocks::deleteById($id, $params, $request);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return CacheLocks::approveById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = CacheLocks::datatables($start, $limit, $order, $dir, $search, $filter);
