...
class JobBatchController extends Controller
{
    public function get(Request $request, $id = null)
    {
        ...
        if ($id != null) {
            $res = JobBatches::getById($id, $params, $request);
        } else if (isset($params['all']) && $params['all']) {
            $res = JobBatches::getAllResult($params, $request);
        } else {
            $res = JobBatches::getPaginatedResult($params, $request);
        }
    ...
    {
        $params = $request->all();
        return JobBatches::createOrUpdate($params, $request->method(), $request);
    }
    ...
    public function delete(Request $request, $id)
    {
        ...
        return JobBatches::deleteById($id, $params, $request);
    }
    ...
    public function approve(Request $request, $id)
    {
        ...
        return JobBatches::approveById($id, $params, $request);
    }
    ...
    public function datatables(Request $request)
    {
        ...
        $res = JobBatches::datatables($start, $limit, $order, $dir, $search, $filter);
